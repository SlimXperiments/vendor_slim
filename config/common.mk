...
SLIMX_VERSION := SlimX-$(PRODUCT_VERSION_X)
SLIM_MOD_VERSION := SlimX-$(SLIM_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(SLIM_BUILD_TYPE)$(SLIM_POSTFIX)
