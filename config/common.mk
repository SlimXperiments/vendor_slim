...
PRODUCT_VERSION_X = 0.1-pre-alpha
...
# Set all versions
SLIM_VERSION := Slim-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)
SLIMX_VERSION := SlimX-$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_X)-$(SLIM_BUILD_TYPE)$(SLIM_POSTFIX)
SLIM_MOD_VERSION := SlimX-$(SLIM_BUILD)-$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_X)-$(SLIM_BUILD_TYPE)$(SLIM_POSTFIX)
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.slimx.version=$(SLIMX_VERSION) \
